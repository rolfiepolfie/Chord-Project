...
class Midimess:
    ...
    def totext(self):
        ...
        if self.type == 'note_on' or self.type == 'note_off':
            ...
            return "unsopported message detected: " + str(self.type) 
...
class Controls:
    ...
    class freezeRoot(Control):
        ...
        """
        name = "FreezeRoot_control"
        msgtype=[MidimsgType.note_on, MidimsgType.note_off]
        note_cc=[12] 
    ...
    class slash_transpose_minus5_chord_minor7(Control):
        ...
        name = "Slash_transpose_minus5_chord_minor7"
        msgtype=[MidimsgType.note_on] #rename to triggerMessages
        note_cc=[17]
        action=Actiontype.momentary
    ...
    class first_alteration_chord(Control):
        ...
        name = "Slash_transpose_minus5_chord_minor7"
        msgtype=[MidimsgType.note_on, MidimsgType.note_off] #rename to triggerMessages
        note_cc=[19]
        action=Actiontype.momentary
    ...
    class invert_chord(Control):
        ...
        name = "invert_chord"
        msgtype=[MidimsgType.controlchange] #rename to triggerMessages
        note_cc=[21]
        action=Actiontype.momentary
    ...
    class special_control(Control):
        ...
        name = "special control that needs special handling! "
        msgtype=[MidimsgType.controlchange, MidimsgType.programchange]
        note_cc=[23]
...
hasattr(ports[1], 'close')
    False

hasattr(ports[0], 'close')
    True
...
class MidiComm():
    ...
    def setMidiChannelChord(self, midichannel):
        self._midichannel_chord = midichannel
        
        
    def setMidiChannelControl(self, midichannel):
        self._midichannel_control = midichannel
    ...
    def startLoop_keyboardlistener(self, portInstance):     
        """ 
        we loop on input ports only 
        """
        def messageloopEmpty():
    ...
    def sendMessage(self, msg):
        """
        for testing purposes sending any message of your whish
